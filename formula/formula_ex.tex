...
\begin{flalign*} %関数_性質
  ...
  (\therefore \frac{\cos^2 x}{\cos^2 x}+\frac{\sin^2 x}{\cos^2 x}=\frac{1}{\cos^2 x})\\
...
\begin{flalign*} % 微分解
  ...
  \frac{dy}{dx} &= \frac{f' \left(t\right)}{g' \left(t\right)} \\
\end{flalign*}
...
\begin{flalign*} % 積分解
  ...
  \int \frac{dx}{\tan x} &= \log \left\lvert \sin x \right\rvert +C \\
...
\begin{flalign*}
  V_n &= \frac{\pi^{\frac{n}{2}}}{\int_{0}^{\infty} t^{\frac{n}{2}} e^{-t} \,dt} \\
\end{flalign*}
