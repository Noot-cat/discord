...
\begin{flalign*}
  ...
  &= \sqrt{3} \cos t \,dt \\
  \int_{- \sqrt{3}}^{\sqrt{3}} \sqrt{3-x^2} \,dx 
  &= \int_{- \frac{\pi}{2}}^{\frac{\pi}{2}} \sqrt{3- \left(\sqrt{3} \sin t \right)^2} \sqrt{3} \cos t \,dt \\
...
\begin{flalign*}
  ...
  dx &= \frac{dt}{\cos^2 t} \\
  \int_{0}^{1} \frac{\,dx}{1+x^2} 
  &= \int_{0}^{\frac{\pi}{4}} \frac{\frac{1}{\cos^2 t}}{\frac{1}{\cos^2 t}} \,dt \\
  &= \int_{0}^{\frac{\pi}{4}} \,dt \\
  &= \frac{\pi}{4} \\
\end{flalign*}
...
\begin{flalign*}
  ...
  I 
  &= \int_{0}^{e} \frac{e^x}{e^{e-x}+e^x} \,dx \: とすると \\
  2I 
  &= \int_{0}^{e} \frac{e^x}{e^{e-x}+e^x} \,dx + \int_{0}^{e} \frac{e^{e-x}}{e^x+e^{e-x}} \,dx \\
...
\begin{flalign*}
  ...
  指数関数の分数関数 &→ 微分接触をつくる \\
  &= \frac{1}{2}\int_{0}^{e} \frac{2e^{2x}}{e^e+e^{2x}} \,dx \\
...
=\int_{0}^{e} \frac{e^x}{e^e \cdot e^{-x}+e^x} \,dx\quad 指数の符号は揃える,指数関数の分数関数→分母分子にe^xをかける\\
指数関数の分数関数→微分接触をつくる\\
...
\begin{flalign*}
  ...
  dt &= \frac{dx}{\cos^2 x} \\
  \int \frac{1}{\tan^4 x} \left(1+\tan^2 x \right)\frac{dx}{\cos^2 x} 
  &= \int \frac{1}{t^4} \left(1+t^2 \right) \,dt \\
...
\begin{flalign*}
  ...
  &= \cosh t \,dt \\
  \int \frac{dx}{\sqrt{1+x^2}} 
  &= \int \frac{1}{\sqrt{1+\sinh^2 t}}\cosh t \,dt \\
  &= \int \,dt \\
  &= t+C \\
...
\begin{flalign*}
  \int \tan^5 x \,dx 
  &= \int \tan^3 x \left(\frac{1}{\cos^2 x}-1 \right) \,dx \\
...
\begin{flalign*}
  \int \frac{dx}{\cos^4x} \quad 三角関数は2乗ごとに分割 \\
  \int \frac{dx}{\cos^4x} 
  &= \int \frac{1}{\cos^2 x} \cdot \frac{1}{\cos^2 x} \,dx \quad \cos^2 xは\tan^2 x \\
...
\begin{flalign*}
  ...
  dx &= \frac{dt}{1+t^2} \\
  \int \frac{dx}{\sin^4 x} 
  &= \int \frac{\left( 1+t^2 \right)^2}{t^4} \cdot \frac{dt}{1+t^2} \\
...
\begin{flalign*}
  \int\frac{\cos^2 x}{\sin x-1} \,dx 
  &= \int \frac{(1-\sin x)(1+\sin x)}{\sin x-1} \,dx \\
  &= -\int(1+\sin x) \,dx \\
  &= \cos x-x+C \\
\end{flalign*}
...
\begin{flalign*}
  ...
  &= \frac{1}{2}\int \sin 2x \cos 2x \\
  &= \frac{1}{4}\int \sin 4x \,dx \\
  &=-\frac{1}{16}\cos 4x+C \\
\end{flalign*}

\begin{flalign*}
  \int_{0}^{\frac{\pi}{2}} \sin 6x\cos 4x \,dx 
  &= \frac{1}{2} \int_{0}^{\frac{\pi}{2}}(\sin 10x+\sin 2x) \,dx \\
...
\begin{flalign*}
  ...
  &= \frac{1}{2}\log (1+\sin^2 x)+C \quad (\because 1+\sin^2 x \ge 0) \\
\end{flalign*}
...
\begin{flalign*}
  ...
  \int_{0}^{1} \frac{dx}{1+x^3} 
  &= \frac{1}{3} \int_{0}^{1} \left( \frac{1}{1+x}-\frac{x-2}{x^2-x+1} \right) \,dx \\
  \frac{1}{3} \int_{0}^{1} \frac{dx}{1+x} 
  &= \frac{1}{3} \left[ \log \left\lvert 1+x \right\rvert \right]_{0}^{1} \\
  &= \frac{1}{3} \log 2 \\
\end{flalign*}
...
\begin{flalign*}
  ...
  \frac{x-2}{x^2-x+1} &= \frac{1}{2}\left(\frac{2x-4}{x^2-x+1}\right) \\
  ...
  \frac{1}{6} \int_{0}^{1} \frac{2x-1}{x^2-x+1} \,dx 
  &= \frac{1}{6}\left[\log \left\lvert x^2-x+1 \right\rvert \right]_{0}^{1} \\
  &= 0 \\
  \frac{1}{2} \int_{0}^{1} \frac{dx}{\left(x-\frac{1}{2}\right)^2+\frac{3}{4}} \\
  x-\frac{1}{2} &= \frac{\sqrt{3}}{2}\tan t \\
  dx &= \frac{\sqrt{3}}{2\cos^2 t} \,dt \\
  \frac{1}{2} \int_{0}^{1} \frac{dx}{\left(x-\frac{1}{2}\right)^2+\frac{3}{4}} 
  &= \frac{1}{2} \cdot \frac{4}{3} \cdot \frac{\sqrt{3}}{2} \int_{- \frac{\pi}{6}}^{\frac{\pi}{6}} \,dt \\
  &= \frac{\pi}{3\sqrt{3}} \\
  \therefore \int_{0}^{1} \frac{dx}{1+x^3} 
  &= \frac{1}{3}\log 2 +\frac{\pi}{3\sqrt{3}} \\
\end{flalign*}

\begin{flalign*}
\int\frac{\cos^2 x}{\sin x-1}\,dx &=\int\frac{(1-\sin x)(1+\sin x)}{\sin x-1} \,dx \\
&=-\int(1+\sin x) \,dx \\
&=\cos x-x+C
\end{flalign*}
...
\begin{flalign*}
  ...
  \frac{1}{3} \int_{0}^{1} \frac{dx}{1+x} &= \frac{1}{3}\left[\log |1+x|\right]_{0}^{1} \\
  &= \frac{1}{3} \log 2 \\
  - \frac{1}{3} \int_{0}^{1} \frac{x-2}{x^2-x+1} \,dx\quad 分母が2次式で分子が1次式→微分接触をつくる\\
  \frac{x-2}{x^2-x+1} &= \frac{1}{2}\left(\frac{2x-4}{x^2-x+1}\right) \\
  &= \frac{1}{2}\left(\frac{2x-1}{x^2-x+1}-\frac{3}{x^2-x+1}\right) \\
...
\begin{flalign*}
  -\frac{1}{3} \int_{0}^{1} \frac{x-2}{x^2-x+1} \,dx &= - \frac{1}{6} \int_{0}^{1} \frac{2x-1}{x^2-x+1} + \frac{1}{6}\int_{0}^{1}\frac{3}{x^2-x+1} \,dx \\
  \frac{1}{6} \int_{0}^{1} \frac{2x-1}{x^2-x+1} \,dx =\frac{1}{6}\left[\log |x^2-x+1|\right]_{0}^{1}\\
  &= 0\\
  ※\int_{0}^{1} \frac{2x-1}{x^2-x+1} \,dx &= \int_{0}^{1} \frac{2(1-x)-1}{(1-x)^2-(1-x)+1} \,dx \\
  =\int_{0}^{1} \frac{-2x+1}{x^2-x+1} \,dx \\
   \therefore I&=-I \\
  2I&=0 \\
  \therefore \int_{0}^{1} \frac{2x-1}{x^2-x+1} \,dx &= 0　\quad 申し訳ないが解説不能.f(x)=x^2-x+1=f(1-x)であることを覚えておくと積分に限らずどこかで使えるかも.
  \end{flalign*}

  \newpage

  \begin{flalign*}
  \frac{1}{6} \int \frac{3}{x^2-x+1} \quad 分子が定数で,分母がD < 0の 2次式→平方完成 \& (x-p)=a \tan t \\
  \frac{1}{2} \int_{0}^{1} \frac{dx}{\left(x-\frac{1}{2}\right)^2+\frac{3}{4}} \\
  x-\frac{1}{2} &= \frac{\sqrt{3}}{2}\tan t \\
  dx &= \frac{\sqrt{3}}{2\cos^2 t} \,dt \\
